...
// Color palette inspired by book cover typography
// Primary blue: #1e4a6d (deep professional blue from cover)
...
const WebsDeLibrosLiderazgo = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#f8f6f1] text-[#1a1a1a] overflow-x-hidden font-sans selection:bg-[#1e4a6d] selection:text-white">
        {/* Header */}
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-4 bg-[#f8f6f1]/95 backdrop-blur-sm border-b border-[#1e4a6d]/10">
          <Link 
            to="/" 
            className="flex items-center gap-2 text-[#1e4a6d] hover:text-[#1e4a6d]/70 transition-colors group"
          >
            <Home className="w-4 h-4" />
            <span className="text-sm tracking-[0.2em] uppercase font-medium">Grupo Dauro</span>
          </Link>
          <div className="flex items-center gap-4">
            <span className="text-sm tracking-[0.2em] uppercase font-medium text-[#1e4a6d] hidden sm:block">Antonio Rodríguez Jiménez</span>
            <Button 
              className="bg-[#1e4a6d] text-white hover:bg-[#1e4a6d]/90 text-xs tracking-widest uppercase"
        ...
        >
          ...
          <div className="absolute inset-0 opacity-[0.03]" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%231e4a6d' fill-opacity='1'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3Cpath d='M30 0v60M0 30h60' stroke='%231e4a6d' stroke-width='0.5'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }} />
          ...
          <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="space-y-8 text-center lg:text-left pt-8 lg:pt-0">
              <div className="inline-block px-4 py-2 border border-[#1e4a6d]/30 rounded-full text-[#1e4a6d] text-xs tracking-[0.3em] uppercase">
                Novedad Editorial 2026
              </div>
              
              <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold leading-[1.1] tracking-tight">
                <span className="text-[#1e4a6d]">La Construcción</span>
                <br />
                <span className="text-[#1e4a6d]">Discursiva</span>
                <br />
                <span className="text-[#1e4a6d]">del </span>
                <span className="italic text-[#c9a45c]">Liderazgo</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button 
                  size="lg"
                  className="bg-[#1e4a6d] text-white hover:bg-[#1e4a6d]/90 font-medium tracking-wide h-12 px-8"
                  onClick={() => document.getElementById('book-section')?.scrollIntoView({ behavior: 'smooth' })}
                >
                  Comprar Ahora
                </Button>
                <Button 
                  size="lg"
                  variant="outline"
                  className="border-[#1e4a6d]/30 text-[#1e4a6d] hover:bg-[#1e4a6d]/5 font-medium tracking-wide h-12 px-8"
            ...
            <div className="flex justify-center lg:justify-end">
              ...
              >
                ...
                >
                  {/* Book shadow */}
                  <div 
                    className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[80%] h-8 bg-[#1e4a6d]/20 blur-2xl rounded-full transition-all duration-700"
                    style={{
                  ...
                  <img 
                    ...
                    style={{
                      boxShadow: bookHover 
                        ? '0 25px 50px -12px rgba(30, 74, 109, 0.4), 0 10px 30px -10px rgba(0, 0, 0, 0.3)'
                        : '0 15px 35px -10px rgba(30, 74, 109, 0.25), 0 5px 15px -5px rgba(0, 0, 0, 0.2)',
                    }}
                  />
          ...
          <button 
            ...
            className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[#1e4a6d]/50 flex flex-col items-center gap-2 cursor-pointer hover:text-[#1e4a6d] transition-colors"
          >
        ...
        >
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="feature-card text-center p-8 rounded-2xl bg-[#f8f6f1] border border-[#1e4a6d]/10 opacity-0" style={{ transform: 'translateY(30px)' }}>
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#1e4a6d]/10 flex items-center justify-center">
                  <Brain className="w-8 h-8 text-[#1e4a6d]" />
                </div>
                <h3 className="text-xl font-serif font-bold text-[#1e4a6d] mb-4">Raíces Filosóficas</h3>
              ...
              <div className="feature-card text-center p-8 rounded-2xl bg-[#f8f6f1] border border-[#1e4a6d]/10 opacity-0" style={{ transform: 'translateY(30px)' }}>
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#1e4a6d]/10 flex items-center justify-center">
                  <Lightbulb className="w-8 h-8 text-[#1e4a6d]" />
                </div>
                <h3 className="text-xl font-serif font-bold text-[#1e4a6d] mb-4">Era Digital</h3>
                <p className="text-[#4a4a4a] leading-relaxed">
              ...
              <div className="feature-card text-center p-8 rounded-2xl bg-[#f8f6f1] border border-[#1e4a6d]/10 opacity-0" style={{ transform: 'translateY(30px)' }}>
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#1e4a6d]/10 flex items-center justify-center">
                  <MessageSquare className="w-8 h-8 text-[#1e4a6d]" />
                </div>
                <h3 className="text-xl font-serif font-bold text-[#1e4a6d] mb-4">Práctica Discursiva</h3>
                <p className="text-[#4a4a4a] leading-relaxed">
        ...
        <section 
          id="synopsis-section"
          ref={synopsisRef}
          className="py-20 md:py-32 bg-[#1e4a6d] text-white"
        >
          <div className="container mx-auto px-4 md:px-8 max-w-5xl">
            <div className="text-center mb-12">
              <span className="inline-block px-4 py-2 border border-white/30 rounded-full text-white/80 text-xs tracking-[0.3em] uppercase mb-6">
                Sinopsis Oficial
              </span>
              <h2 className="synopsis-title text-3xl md:text-4xl lg:text-5xl font-serif font-bold opacity-0" style={{ transform: 'translateX(-30px)' }}>
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
              ...
              <div className="book-image-container flex justify-center opacity-0">
                ...
                >
                  <img 
                    ...
                    className="w-full max-w-sm rounded-sm shadow-2xl shadow-[#1e4a6d]/20 group-hover:shadow-[#1e4a6d]/30 transition-shadow duration-500"
                    src="/products/construccion-discursiva-liderazgo.png"
                  />
                  <div className="absolute -top-4 -left-4 w-full h-full border-2 border-[#c9a45c]/30 -z-10 rounded-sm hidden md:block" />
                  <div className="absolute -bottom-4 -right-4 w-full h-full border-2 border-[#1e4a6d]/20 -z-10 rounded-sm hidden md:block" />
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div>
                  <div className="inline-block px-3 py-1 border border-[#c9a45c] rounded-full text-[#c9a45c] text-xs tracking-widest mb-6 uppercase">
                    Disponible Ahora
                  </div>
                  <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#1e4a6d] mb-4">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button 
                      size="lg"
                      className="bg-[#1e4a6d] text-white hover:bg-[#1e4a6d]/90 font-medium tracking-wide h-14 px-8 text-base"
                    ...
                    <Button 
                      size="lg"
                      variant="outline"
                      className="border-[#1e4a6d]/30 hover:bg-[#1e4a6d]/5 text-[#1e4a6d] font-medium tracking-wide h-14 px-8 text-base"
                ...
                <div className="flex flex-wrap items-center gap-6 text-sm text-[#4a4a4a] pt-4 border-t border-[#1e4a6d]/10">
                  <div className="flex items-center gap-2">
                    <Feather className="w-4 h-4 text-[#1e4a6d]" />
                    <span>Envío gratuito a España</span>
                  </div>
                  <button 
                    className="flex items-center gap-2 hover:text-[#1e4a6d] transition-colors cursor-pointer"
                    onClick={async () => {
                      const shareData = {
        ...
        <section 
          ref={authorRef}
          className="py-20 md:py-32 bg-white border-t border-[#1e4a6d]/10"
        >
          <div className="container mx-auto px-4 md:px-8 max-w-5xl">
            <div className="flex flex-col md:flex-row items-center gap-12">
              {/* Author Photo */}
              <div className="author-photo flex-shrink-0 opacity-0" style={{ transform: 'scale(0.9)' }}>
                <div className="w-48 h-64 md:w-56 md:h-72 rounded-[50%] overflow-hidden border-4 border-[#1e4a6d]/20 shadow-2xl shadow-[#1e4a6d]/10">
                  <img 
              ...
              <div className="author-bio flex-1 text-center md:text-left opacity-0" style={{ transform: 'translateY(20px)' }}>
                <h3 className="font-serif text-2xl md:text-3xl text-[#c9a45c] mb-2">Sobre el Autor</h3>
                <h4 className="font-serif text-xl md:text-2xl text-[#1e4a6d] mb-4">Antonio Rodríguez Jiménez</h4>
                <p className="text-sm uppercase tracking-widest text-[#4a4a4a] mb-6">Doctor en Teoría de la Literatura y Comunicación</p>
                ...
                <div className="space-y-4 text-[#4a4a4a] leading-relaxed">
                  ...
                  <p>
                    Tiene en su haber <span className="text-[#1e4a6d] font-semibold">67 libros publicados</span>. Es miembro del Sistema Nacional de Investigadores de CONAHCYT (Nivel II) y académico numerario de la Academia Hispanoamericana de Buenas Letras.
                  </p>
                  <p>
        ...
        {/* Footer */}
        <footer className="bg-[#1e4a6d] py-8 text-center text-white/60 text-xs border-t border-white/10">
