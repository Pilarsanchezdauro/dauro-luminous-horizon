...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-[8vh] md:pt-[10vh] pb-[6vh] md:pb-[8vh]">
      ...
      >
        <p className="text-[1.75rem] md:text-[3rem] font-bold leading-[1.15] md:leading-[1.1] tracking-[0.01em] md:tracking-[0.02em] text-[#666666] mb-3 md:mb-4 animate-fade-in text-center max-w-[95%] md:max-w-none mx-auto">
