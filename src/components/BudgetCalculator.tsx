...
// Precios basados en costos reales de producción premium + 15% margen
const PRICE_TIERS = [
  { min: 1, max: 100, price: 495 },
  { min: 101, max: 150, price: 595 },
  { min: 151, max: 200, price: 695 },
  { min: 201, max: 250, price: 795 },
  { min: 251, max: 300, price: 895 },
  { min: 301, max: 400, price: 1050 },
];

// Copy options with price per additional copy beyond base 50
// Basado en costos de producción premium + 15% margen
const COPIES_OPTIONS = [
  { copies: 50, label: '50 ejemplares', extraCost: 0 },
  { copies: 75, label: '75 ejemplares', extraCost: 125 },
  { copies: 100, label: '100 ejemplares', extraCost: 245 },
  { copies: 150, label: '150 ejemplares', extraCost: 420 },
  { copies: 200, label: '200 ejemplares', extraCost: 580 },
  { copies: 300, label: '300 ejemplares', extraCost: 870 },
];
