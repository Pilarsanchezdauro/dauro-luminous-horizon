...
const Page = forwardRef<HTMLDivElement, PageProps>(({ src, pageNumber, isCover }, ref) => {
  return (
    <div ref={ref} className={`${isCover ? 'bg-[#1a3a5c]' : 'bg-[#f8f5ed]'} shadow-xl`}>
      <img 
        src={src} 
...
// Flipbook pages for "La Construcción Discursiva del Liderazgo"
const flipbookPages = [
  "/webs-libros/liderazgo/flipbook/page-1.jpg",
  "/webs-libros/liderazgo/flipbook/page-2.jpg",
  "/webs-libros/liderazgo/flipbook/page-3.jpg",
  "/webs-libros/liderazgo/flipbook/page-4.jpg",
  "/webs-libros/liderazgo/flipbook/page-5.jpg",
  "/webs-libros/liderazgo/flipbook/page-6.jpg",
  "/webs-libros/liderazgo/flipbook/page-7.jpg",
  "/webs-libros/liderazgo/flipbook/page-8.jpg",
  "/webs-libros/liderazgo/flipbook/page-9.jpg",
  "/webs-libros/liderazgo/flipbook/page-10.jpg",
  "/webs-libros/liderazgo/flipbook/page-11.jpg",
  "/webs-libros/liderazgo/flipbook/page-12.jpg",
  "/webs-libros/liderazgo/flipbook/page-13.jpg",
  "/webs-libros/liderazgo/flipbook/page-14.jpg",
  "/webs-libros/liderazgo/flipbook/page-15.jpg",
  "/webs-libros/liderazgo/flipbook/page-16.jpg",
  "/webs-libros/liderazgo/flipbook/page-17.jpg",
  "/webs-libros/liderazgo/flipbook/page-18.jpg",
  "/webs-libros/liderazgo/flipbook/page-19.jpg",
  "/webs-libros/liderazgo/flipbook/page-20.jpg",
];
...
const LiderazgoFlipbook = ({ className = "" }: LiderazgoFlipbookProps) => {
  ...
  const bookWidth = isFullscreen ? 550 : 450;
  const bookHeight = isFullscreen ? 770 : 630;
  ...
  const FlipbookContent = () => (
    <>
      ...
      <div className="relative">
        {/* Decorative glow */}
        <div className="absolute inset-0 -m-8 bg-gradient-to-r from-[#1a3a5c]/5 via-[#1a3a5c]/10 to-[#1a3a5c]/5 blur-3xl rounded-full pointer-events-none" />
        ...
        <div className="relative group">
          ...
          <HTMLFlipBook
            ...
            height={bookHeight}
            size="stretch"
            minWidth={isFullscreen ? 450 : 350}
            maxWidth={isFullscreen ? 700 : 650}
            minHeight={isFullscreen ? 630 : 490}
            maxHeight={isFullscreen ? 980 : 910}
            showCover={true}
      ...
      <div className="flex flex-col items-center gap-4 mt-6">
        ...
        <div className="w-64 md:w-80 h-1 bg-white/10 rounded-full overflow-hidden">
          <div 
            className="h-full bg-gradient-to-r from-[#c9a45c] to-[#c9a45c]/70 transition-all duration-300"
        ...
        {currentPage > 2 && (
          <Button
            ...
            size="sm"
            onClick={goToStart}
            className="text-[#c9a45c]/70 hover:text-[#c9a45c] text-xs"
          >
            Volver al inicio
          </Button>
        )}
    ...
    <>
      ...
      <div className={`flex flex-col items-center gap-8 ${className}`}>
        ...
        <div className="text-center space-y-3">
          <div className="flex items-center justify-center gap-3 text-[#c9a45c]">
            <div className="h-px w-12 bg-gradient-to-r from-transparent to-[#c9a45c]/50" />
            <BookOpen className="w-6 h-6" />
            <div className="h-px w-12 bg-gradient-to-l from-transparent to-[#c9a45c]/50" />
          </div>
        ...
        <p className="text-white/40 text-sm text-center max-w-lg px-4">
          ¿Te gusta lo que lees? Consigue el libro completo y sumérgete en el fascinante análisis del liderazgo.
        </p>
      </div>
      ...
      {isFullscreen && (
        ...
        >
          ...
          {/* Title */}
          <h3 className="text-xl md:text-2xl font-medium text-white mb-6 text-center tracking-tight">
...
export default LiderazgoFlipbook;
